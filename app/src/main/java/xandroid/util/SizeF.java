...
public final class SizeF {
    ...
    public SizeF(final float width, final float height) {
        if (width == Float.NEGATIVE_INFINITY || width == Float.POSITIVE_INFINITY) new ArithmeticException("width is infinite");
        if (height == Float.NEGATIVE_INFINITY || height == Float.POSITIVE_INFINITY) new ArithmeticException("height is infinite");
        mWidth = width;
        mHeight = height;
    }
    /**
